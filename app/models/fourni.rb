class Fourni < ApplicationRecord
    ...
    validates :num_f, :presence => {message: "Veuillez entrer un numero." }, :numericality => {message: "Il faut des chiffres." }, :length => { minimum: 9, maximum: 9, message: "Veuillez entrer un numero correct (10 chiffres)." }
end
